...
| `janggi/` | 다람쌤 장기 한판 (한국 장기, AI 4단계) | 정적 페이지 |
...
- **혼자 달리기**(컴퓨터 7대) · **둘이 나눠 달리기**(한 기기 분할 화면) · **기록 도전** → 서버 없이 바로 사용
- **친구들과 함께 달리기**(최대 8명 실시간) → `kart-online-worker.js`를 Worker에 붙여넣고
  `KART_ROOM` 이름으로 Durable Object를 연결하면 방 번호 6자리로 모일 수 있습니다
- 학생에게서 받는 것은 **별명뿐**입니다. 최고 기록은 그 학생 기기에만 남습니다

자세한 배포·수업 활용법은 `kart/README.md`에 있습니다.
