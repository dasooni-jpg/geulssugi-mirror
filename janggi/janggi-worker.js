...
<div id="app">
  ...
  <section id="screen-menu" class="screen active">
    ...
    <div class="menu-grid">
      ...
      <button class="menu-btn" data-go="puzzles">
        ...
        <span class="md">13문제 · 1수 · 2수 · 3수 외통 (정답을 엔진으로 검증함)</span>
      </button>
  ...
  <section id="screen-puzzles" class="screen">
    ...
    <div class="subtitle">초(楚)를 잡고 정해진 수 안에 <b>외통</b>을 만드세요 · 상대는 가장 끈질긴 수로 버팁니다</div>
...
const PUZZLES = [
  { n: 1, cho: 'K04 P96 R58 R82', han: 'K74' },
  { n: 1, cho: 'K03 R77 E55 E78', han: 'K95 S85' },
  { n: 1, cho: 'K25 H53 R41',     han: 'K73 S83 S74' },
  { n: 1, cho: 'K05 R45 H72',     han: 'K95 S94 S93 J75' },
  { n: 1, cho: 'K24 H56 J65 E41', han: 'K74 S75' },
...
/* ============================================================================
   6-2. 묘수풀이
   ============================================================================ */
const PZKEY = 'daram-janggi-puzzles-v1';
function loadSolved() {
...
$('puzzle-grid').addEventListener('click', ev => {
