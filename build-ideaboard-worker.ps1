# ─────────────────────────────────────────────────────────────
#  IdeaBoard Cloudflare Worker builder
#  ideaboard-app/app.html + ideaboard-worker.template.js → ideaboard-worker.js
#  Run:  powershell -ExecutionPolicy Bypass -File build-ideaboard-worker.ps1
# ─────────────────────────────────────────────────────────────
...
# copy for the browser test harness (ideaboard-app/_test.html)
Copy-Item $dest (Join-Path $root "ideaboard-app\_worker.js") -Force
...
Write-Host "-> Verify: run ideaboard-server.ps1 then open http://localhost:4195/_test.html (all PASS)"
